$(document).ready(function() {
	...
	dataTable.initDataTable('tableGroupList', url + 'worklife/manager/group/getListGroup.do');
			            	...
			            	if (tableSetting != undefined) {
			                	...
			                	if (setting[0][0] != undefined) {
				                	switch(setting[0][0]) {
				                		...
				                		case 2: columnName = "group_description"; break;
				                	}
				                	if (columnName != "") {
					            		d.column = columnName;
		            ...
		            'dataSrc': function(json) {
		    			if (json != undefined && json != null && json.data != undefined && json.data != null) {
		    				for ( var i = 0, ien = json.data.length; i < ien; i++) {
		    					json.data[i][2] = '<a href="' + url + 'worklife/manager/group/modify/modifyGroup.do?groupId=' + json.data[i][0] + '" >' + json.data[i][2] + '</a>';
