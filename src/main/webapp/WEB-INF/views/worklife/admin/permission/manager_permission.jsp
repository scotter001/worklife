...
<head>
	...
	<script src="<c:url value='/style/js/worklife/admin/manager_permission/manager_permission.js'/>" type="text/javascript"></script>	
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li class="active">
							<strong><spring:message code="label.lowercase.managepermission" /></strong>
						</li>
					</ol>
				</div>
			...
			<div class="animated fadeInRight m-t p-b-lg">
				<form class="form" action="${pageContext.request.contextPath}/worklife/manager/permission/create/newPermission.do" id="roleManager" name="roleManager" method="GET">
					<input type="hidden" name="pageNumber" id="pageNumber"/>
					<div class="row animated fadeInRight">
						<div class="col-lg-12">
							<div class="ibox float-e-margins">
								<div class="ibox-title">
									<h5><spring:message code="label.lowercase.managerole" /></h5>
									...
									<div class="form-role">
										<div class="row">
											<div class="col-lg-12 col-md-12">
												<table class="table table-bordered dataTables-example" id="tableRoleList" style="width: 100%">
													<thead>
														<tr>
															<th style="width: 5%; padding-right: 3px !important;" class="text-center"><spring:message code="label.number" /></th>
															<th style="width: 15%" class="text-center"><spring:message code="label.permissionname" /></th>
															<th style="width: 25%" class="text-center"><spring:message code="label.permissionpattern" /></th>
															<th style="width: 20%" class="text-center"><spring:message code="label.permissiongroupnameth" /></th>
															<th style="width: 10%" class="text-center"><spring:message code="label.permissiongroupno" /></th>
