...
<head>
	...
	<script src="<c:url value='/style/js/worklife/admin/manager_role_group/manager_role_group.js'/>" type="text/javascript"></script>	
	...
	<script type="text/javascript">
		...
		var next = '<spring:message code="label.next"/>';
 		...
 		var askdelete = '<spring:message code="delete.rolegroup.askdelete"/>';
 		var deleteok = '<spring:message code="delete.rolegroup.deleteok"/>';
 		var deletefalse = '<spring:message code="delete.rolegroup.deletefalse"/>';
 		var notchange = '<spring:message code="delete.rolegroup.notchange"/>';
	</script>
	<style type="text/css">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li class="active">
							<strong><spring:message code="label.lowercase.managerole2" /></strong>
						</li>
					</ol>
				</div>
						...
						<div class="col-lg-12">
							<div class="ibox float-e-margins">
								<div class="ibox-title">
									<h5><spring:message code="label.lowercase.managerole2" /></h5>
									<div class="ibox-tools mgt7" style="margin-top: -7px;">
										<button type="button" class="btn btn-danger btn-sm" id="deleterole">
									...
									<div class="form-group">
										...
										<div class="row">
											<div class="col-lg-12 col-md-12">
												<table class="table table-bordered dataTables-example" id="tableRoleGroupList" style="width: 100%">
													<thead>
														<tr>
															<th style="width: 5%; padding-right: 3px !important;" class="text-center"><spring:message code="label.number" /></th>
															<th style="width: 20%" class="text-center"><spring:message code="label.rolegroup.code" /></th>
															<th style="width: 20%" class="text-center"><spring:message code="label.rolegroup.name" /></th>
															<th style="width: 35%" class="text-center"><spring:message code="label.rolegroup.description" /></th>
															<th style="width: 20%" class="text-center"><spring:message code="label.groupname" /></th>
														</tr>
													</thead>
												</table>
											</div>
