...
<head>
	...
	<script src="<c:url value='/style/js/worklife/admin/manager_permission_group/manager_permission_group.js'/>" type="text/javascript"></script>	
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li class="active">
							<strong><spring:message code="label.lowercase.administratepermissiongroup" /></strong>
						</li>
					</ol>
				</div>
			...
			<div class="animated fadeInRight m-t p-b-lg">
				<form class="form" action="${pageContext.request.contextPath}/worklife/manager/permissiongroup/create/newPermissionGroup.do" id="groupManager" name="groupManager" method="GET">
					<input type="hidden" name="pageNumber" id="pageNumber"/>
					<div class="row animated fadeInRight">
						<div class="col-lg-12">
							<div class="ibox float-e-margins">
								<div class="ibox-title">
									<h5><spring:message code="label.lowercase.managepermissiongroup" /></h5>
												...
												<table class="table table-bordered dataTables-example" id="tableGroupList" style="width: 100%">
													<thead>
														<tr>
															...
															<th style="width: 35%" class="text-center"><spring:message code="label.parentgroupname3" /></th>
															<th style="width: 40%" class="text-center"><spring:message code="label.rolerelate.listrole" /></th>
														</tr>
													</thead>
												</table>
											</div>
