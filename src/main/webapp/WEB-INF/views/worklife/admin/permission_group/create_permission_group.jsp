...
<head>
	...
	<script src="<c:url value='/style/js/worklife/admin/manager_permission_group/create_permission_group.js'/>" type="text/javascript"></script>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="animated fadeInRight m-t p-b-lg">
				<form:form class="form" id="createGroupRole" name="createGroupRole" action="${pageContext.request.contextPath}/worklife/manager/permissiongroup/create/insertPermissionGroup.do" method="POST">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="ibox float-e-margins" style="margin-bottom: 0px;">
											<div class="ibox-title">
												<h5><spring:message code="label.update" /> <spring:message code="label.permission" /></h5>
											</div>
