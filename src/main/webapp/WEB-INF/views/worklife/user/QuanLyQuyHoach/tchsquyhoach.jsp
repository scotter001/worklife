...
<html>
<head>
    <title>Tra cứu hồ sơ quy hoạch</title>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h3><b>TRA CỨU HỒ SƠ QUY HOẠCH</b></h3>
                </div>
                <div class="ibox-content">
                    <div class="row">
                        <c:choose>
                            <c:when test="${maHuyen == -1}">
                                <div class="col-md-2 col-md-offset-3">
                                    <label>Đơn vị quản lý</label>
                                    <select class="form-control" id="donViQL"></select>
                                </div>
                            </c:when>
                        </c:choose>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class=" col-md-12">
                            ...
                            <table class="table table-bordered table-hover dataTables-example dataTable"
                                   id="tableTraCuuQuyHoach" aria-describedby="DataTables_Table_0_info" role="grid">
                                <thead>
                                <tr role="row">
                ...
                <form id="formKTHS">
                    ...
                    <input type="hidden" id="maHuyen" name="maHuyen" value="${maHuyen eq null ? -1 : maHuyen}">
...
<script type="text/javascript"
        src="<c:url value='/style/js/worklife/user/quanlyquyhoach/tchsquyhoach.Form.js' />"></script>
<script type="text/javascript">
    let multiLanguage = {
