...
<html>
<head>
    <title>Cấp phép cải tạo vỉa hè</title>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h3><b>CẤP PHÉP CẢI TẠO VỈA HÈ</b></h3>
                </div>
                                                ...
                                                <div class="ibox-content">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-3">
                                                                <label>Đơn số, Ngày</label>
                                                                <c:if test="${congTrinhVO.donXinCP eq null}">
                                                                    <textarea class="form-control" rows="1" name="donXinCP" >${congTrinhVO.donXinCP}</textarea>
                                                                </c:if>
                                                                <c:if test="${congTrinhVO.donXinCP != null}">
                                                                    <textarea class="form-control" rows="1" name="donXinCP">${congTrinhVO.donXinCP}</textarea>
                                                                </c:if>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <input type="text" class="form-control"  disabled value="${congTrinhVO1.ten}">
                                                                <input type="hidden"  name="idLoaiCongTrinh" value="${congTrinhVO1.idLoaiHS}">

                                                            </div>
                                                            <div class="col-md-3">
                                                                <label>Địa chỉ công trình, tuyến đường</label>
                                                                <input type="text" class="form-control" name="diaDiem_DiaChi" id="diaDiem_DiaChi" value="${congTrinhVO.diaDiem_DiaChi}">
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label>Thuộc huyện</label>
                                                                <select type="text" class="form-control" multiple="multiple" name="nhieuHuyen" id="nhieuHuyen" data="${congTrinhVO2.listIdHuyen}"></select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <c:if test="${congTrinhVO.noiDung_CapPhep == ''}">
                                                                <textarea class="form-control" rows="3" id="noiDung_CapPhep" name="noiDung_CapPhep"> Cải tạo vỉa hè trong phạm vi đất của đường bộ ${congTrinhVO.diaDiem_DiaChi}, Thuộc huyên: ${congTrinhVO2.nhieuHuyen}</textarea>
                                                            </c:if>
                                                            <c:if test="${congTrinhVO.noiDung_CapPhep != ''}">
                                        ...
                                        <div id="giayPhepCongTrinh" class="tab-pane hidden">
                                            <div class="ibox float-e-margins m-n">
                                                <div class="ibox-content">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <textarea  class="form-control middle" style="font-weight:bold ;" rows="2" name="tieuDe" id="tieuDe"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label>Căn cứ pháp lý</label>
                                                            <textarea class="form-control" rows="7" name="canCu" id="canCu"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12 text-right">
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea class="form-control" rows="23" name="noiDungGP" id="noiDungGP"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
...
<script type="text/javascript" src="<c:url value='/style/js/worklife/qlctgt/user/xulyhoso/hscpcaitaoviahe/hscpcaitaoviahe.Form.js' />"></script>
