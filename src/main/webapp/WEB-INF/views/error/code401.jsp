...
<body class="gray-bg">
    <div class="middle-box text-center animated fadeInDown">
        ...
        <div class="error-desc">
           Bạn không có quyền truy cập, vui lòng quay lại hoặc truy cập tài liệu khác.<br/>
           <a onclick="window.history.back();" class="btn btn-primary m-t">Trở về trang trước</a>
        </div>
    </div>
</body>
</html>